...
// Filter reviews
  ...
  return (
    <section className="bg-white py-8 antialiased dark:bg-gray-700 md:py-16">
      <div className="ml-4 mx-auto max-w-screen-xl px-4 2xl:px-0">
        <div className="flex items-center gap-2">
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-white">
            Ratings & Reviews of Products
          </h2>
        ...
        <div className="mt-6 divide-y divide-gray-200 dark:divide-gray-800">
          {reviews?.length > 0 && (
            <div className="mr-12 flex flex-wrap items-center justify-between gap-4 py-3">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white">
                Products Reviews
              </h2>
