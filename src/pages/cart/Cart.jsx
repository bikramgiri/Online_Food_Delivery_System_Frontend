...
import { addToFavorites, removeItem } from '../../store/cartSlice'
...
const Cart = () => {
  ...
  <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
    <h1 className="font-bold text-3xl text-yellow-900 md:text-3xl text-center">Cart Items</h1>
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
              <a href="#" className="shrink-0 md:order-1">
                <img className="h-30 w-40 dark:block" src={product.productImage} alt={product.productName} />
              </a>
              ...
              <div className="flex items-center justify-between md:order-3 md:justify-end">
                ...
                <div className="text-end md:order-4 md:w-32">
                  <p className="text-base font-bold text-gray-900 dark:text-white">${product.productPrice}</p>
                </div>
              </div>

              <div className="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                <a href="#" className="text-base font-medium text-gray-900 hover:underline dark:text-white">{product.productName}</a>

                <div className="flex items-center gap-4">
                  <button onClick={() => favorite(product._id)} type="button" className="inline-flex items-center text-sm font-medium text-gray-500 hover:text-gray-900 hover:underline dark:text-gray-400 dark:hover:text-white">
                  ...
                  <button onClick={() => remove(product._id)} type="button" className="inline-flex items-center text-sm font-medium text-red-600 hover:underline dark:text-red-500">
                    <svg className="me-1.5 h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
