          ...
          <div className="flex space-x-4">
            {(!user || user.length === 0) && !localStorage.getItem("token") ? (
              <>
                <Link
                  to="/register"
                  className="block py-2 px-3 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-gray-800 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
                >
                  Register
                </Link>
                <Link
      ...
      <nav className="bg-white border-gray-200 dark:bg-gray-800">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className=" flex items-center space-x-6 md:order-1">
            ...
            {isDropdownOpen && (
              <div
                className="mt-118 ml-13 absolute z-50 my-4 w-64 text-base list-none bg-gray-800 divide-y divide-gray-700 rounded-lg shadow-lg dark:divide-gray-600"
                id="user-dropdown"
              >
                {/* User Info */}
                ...
                <ul className="py-2 space-y-2">
                  ...
                  <li>
                    <Link to="/reviews" className="flex items-center px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 dark:hover:text-white transition-colors">
                      <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
